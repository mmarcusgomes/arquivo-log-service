...
namespace FeatureLogArquivos.Repository
{
    public class LogRepository : ILogRepository
    {
        ...
        public LogRepository(ApplicationContext contexto, IConfiguration configuration)
        {
            _contexto = contexto;
        ...
        public void LogUpdateAoContext<T>(string nomeUsuario, Guid idReferencia, object originalObj = null, EnumOperacaoHistorico operacao = EnumOperacaoHistorico.Atualizar)
        {
            ...
            //Adicionando ao contexto para ser salvo pelo savechanges do repositorio pai que chamou o serviço de log
            if (!string.IsNullOrWhiteSpace(MensagemLog))
            {
                _contexto.Historicos.Add(new Historico()
                {
        ...
        //public void LogUpdateAoContext<T>(string nomeUsuario, Guid idReferencia, object obj = null, EnumOperacaoHistorico operacao = EnumOperacaoHistorico.Atualizar)
        //{
