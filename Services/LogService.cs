...
namespace FeatureLogArquivos.Services
{
    public class LogService : ILogService
    {
        ...
        public void LogChanges<T>(string nomeUsuario,Guid idReferencia, object obj = null, EnumOperacaoHistorico operacao = EnumOperacaoHistorico.Atualizar)
        {
            _logRepository.LogUpdateAoContext<T>(nomeUsuario, idReferencia, obj, operacao);
        }
